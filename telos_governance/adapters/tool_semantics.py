...
FS_READ_FILE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # High-traffic: 15 exemplars in bridge buildActionText() format
        # Bridge: "Read {classifyPath} file in project workspace for analysis: {shortPath}"
        ...
        "Read source code file in project workspace for analysis: tests/test_app.py",
        "Read configuration file in project workspace for analysis: package.json",
        "Read source code file in project workspace for analysis: src/config.py",
        "Read configuration file in project workspace for analysis: .github/workflows/ci.yml",
        "Read documentation file in project workspace for analysis: docs/api_reference.md",
        "Read source code file in project workspace for analysis: src/utils/helpers.py",
        "Read configuration file in project workspace for analysis: requirements.txt",
        "Read project file in project workspace for analysis: Makefile",
        "Read source code file in project workspace for analysis: src/models/user.py",
        "Read source code file in project workspace for analysis: tests/conftest.py",
        "Read configuration file in project workspace for analysis: pyproject.toml",
        "Read source code file in project workspace for analysis: src/handlers/auth.py",
        "Read documentation file in project workspace for analysis: CHANGELOG.md",
    ],
    scope_constraints=[
...
FS_WRITE_FILE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Write {classifyPath} file in project workspace: {shortPath}"
        "Write source code file in project workspace: src/utils.py",
        "Write source code file in project workspace: tests/test_new_feature.py",
        "Write source code file in project workspace: src/models/schema.py",
        "Write configuration file in project workspace: config/settings.yaml",
        "Write source code file in project workspace: scripts/setup.py",
        "Write source code file in project workspace: src/handlers/webhook.py",
        "Write configuration file in project workspace: tests/fixtures/sample_data.json",
        "Write source code file in project workspace: src/middleware/auth.py",
        "Write configuration file in project workspace: docker-compose.yml",
        "Write source code file in project workspace: src/api/routes.py",
    ],
    scope_constraints=[
...
FS_EDIT_FILE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Edit {classifyPath} file in project workspace: {shortPath}"
        "Edit source code file in project workspace: src/main.py",
        "Edit source code file in project workspace: src/config.py",
        "Edit source code file in project workspace: tests/test_handler.py",
        "Edit source code file in project workspace: src/models/user.py",
        "Edit configuration file in project workspace: package.json",
        "Edit source code file in project workspace: src/utils/validation.py",
        "Edit configuration file in project workspace: requirements.txt",
        "Edit source code file in project workspace: src/api/endpoints.py",
        "Edit configuration file in project workspace: .env.example",
        "Edit source code file in project workspace: src/database/migrations.py",
        "Edit configuration file in project workspace: pyproject.toml",
        "Edit source code file in project workspace: src/services/email.py",
        "Edit configuration file in project workspace: tsconfig.json",
    ],
    scope_constraints=[
...
FS_LIST_DIRECTORY = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Search project codebase files by pattern: {pattern}"
        "Search project codebase files by pattern: **/*.py",
        "Search project codebase files by pattern: src/**/*.ts",
        "Search project codebase files by pattern: tests/**/*.test.js",
        "Search project codebase files by pattern: **/*.yaml",
        "Search project codebase files by pattern: src/components/**/*.tsx",
        "Search project codebase files by pattern: **/*.md",
        "Search project codebase files by pattern: **/Dockerfile",
        "Search project codebase files by pattern: src/**/*.py",
        "Search project codebase files by pattern: **/*.json",
        "Search project codebase files by pattern: tests/**/conftest.py",
        "Search project codebase files by pattern: **/*.sql",
        "Search project codebase files by pattern: src/**/*.go",
    ],
    scope_constraints=[
...
FS_SEARCH_FILES = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Search project codebase with text search for: {pattern}"
        "Search project codebase with text search for: TODO",
        "Search project codebase with text search for: FIXME",
        "Search project codebase with text search for: import logging",
        "Search project codebase with text search for: class.*Handler",
        "Search project codebase with text search for: def test_",
        "Search project codebase with text search for: raise.*Error",
        "Search project codebase with text search for: async def",
        "Search project codebase with text search for: from.*import",
        "Search project codebase with text search for: API_KEY",
        "Search project codebase with text search for: @app.route",
        "Search project codebase with text search for: SELECT.*FROM",
        "Search project codebase with text search for: console.log",
        "Search project codebase with text search for: function\\s+\\w+",
        "Search project codebase with text search for: deprecated",
    ],
    scope_constraints=[
...
RUNTIME_EXECUTE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Execute shell command in project workspace -- {classifyCommand}: {cmd}"
        "Execute shell command in project workspace -- version control: git status",
        "Execute shell command in project workspace -- version control: git diff",
        "Execute shell command in project workspace -- version control: git log --oneline -10",
        "Execute shell command in project workspace -- version control: git add src/main.py",
        "Execute shell command in project workspace -- version control: git commit -m \"fix: resolve import error\"",
        "Execute shell command in project workspace -- test execution: pytest tests/ -v",
        "Execute shell command in project workspace -- test execution: pytest tests/ -q",
        "Execute shell command in project workspace -- test execution: python3 -m pytest",
        "Execute shell command in project workspace -- dependency management: pip install -e .",
        "Execute shell command in project workspace -- dependency management: npm install",
        "Execute shell command in project workspace -- shell operation: npm run build",
        "Execute shell command in project workspace -- script execution: python3 script.py",
        "Execute shell command in project workspace -- filesystem inspection: ls -la",
        "Execute shell command in project workspace -- filesystem inspection: wc -l src/*.py",
        "Execute shell command in project workspace -- script execution: node src/index.js",
    ],
    scope_constraints=[
...
RUNTIME_PROCESS = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Execute shell command in project workspace -- {intent}: {cmd}"
        "Execute shell command in project workspace -- shell operation: start dev server in background",
        "Execute shell command in project workspace -- shell operation: check background process status",
        "Execute shell command in project workspace -- shell operation: stop background dev server",
        "Execute shell command in project workspace -- shell operation: list running background processes",
        "Execute shell command in project workspace -- shell operation: poll background task output",
        "Execute shell command in project workspace -- shell operation: kill hung test process",
    ],
    scope_constraints=[
...
WEB_FETCH = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Fetch web resource: {url}"
        "Fetch web resource: https://docs.python.org/3/library/asyncio.html",
        "Fetch web resource: https://fastapi.tiangolo.com/tutorial/",
        "Fetch web resource: https://react.dev/reference/react",
        "Fetch web resource: https://docs.djangoproject.com/en/5.0/",
        "Fetch web resource: https://numpy.org/doc/stable/reference/",
        "Fetch web resource: https://developer.mozilla.org/en-US/docs/Web/API",
        "Fetch web resource: https://docs.github.com/en/rest",
        "Fetch web resource: https://kubernetes.io/docs/concepts/",
    ],
    scope_constraints=[
...
WEB_SEARCH = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Search the web for: {query}"
        "Search the web for: Python asyncio best practices",
        "Search the web for: React hooks documentation 2026",
        "Search the web for: FastAPI dependency injection tutorial",
        "Search the web for: PostgreSQL index optimization",
        "Search the web for: Docker compose networking guide",
        "Search the web for: TypeScript generic constraints",
        "Search the web for: pytest fixture scope documentation",
        "Search the web for: error message stack trace solution",
    ],
    scope_constraints=[
...
MESSAGING_SEND = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Send message to {channel}: {preview}"
        "Send message to engineering: build passed -- all 237 tests green",
        "Send message to team-slack: PR #142 ready for review",
        "Send message to deploys: deployment to staging complete",
        "Send message to test-results: pytest run finished -- 0 failures",
        "Send message to status: daily status update",
        "Send message to releases: v2.1.0 release notes posted",
        "Send message to code-review: feedback on auth handler refactor",
        "Send message to standup: daily standup summary",
    ],
    scope_constraints=[
...
MESSAGING_READ = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Read messages from {channel}"
        "Read messages from team-updates",
        "Read messages from deploys",
        "Read messages from code-review",
...
MESSAGING_REPLY = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Send message to {channel}: {preview}" (reply uses same template)
        "Send message to code-review: responding to review comment on auth handler",
        "Send message to deploys: acknowledged deployment notification",
        "Send message to engineering: answered question about API rate limits",
        "Send message to alerts: confirmed build failure investigated",
        "Send message to tasks: task completion confirmed",
    ],
    scope_constraints=[
...
AUTOMATION_CRON_CREATE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Create scheduled task: {schedule}"
        "Create scheduled task: 0 2 * * * -- nightly test run",
        "Create scheduled task: */30 * * * * -- periodic health check",
        "Create scheduled task: 0 3 * * * -- daily backup",
        "Create scheduled task: 0 * * * * -- hourly monitoring",
        "Create scheduled task: 0 4 * * 1 -- weekly dependency audit",
    ],
    scope_constraints=[
...
SESSIONS_SAVE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Create sub-agent task: {desc}" / "Update task status: {id}"
        "Create sub-agent task: implement authentication handler",
        "Create sub-agent task: run integration test suite",
        "Update task status: task-abc123",
        "Update task status: task-def456",
        "Create sub-agent task: refactor database queries",
        "Create sub-agent task: write unit tests for API",
        "Update task status: task-ghi789",
        "Create sub-agent task: create subtask for testing",
    ],
    scope_constraints=[
...
SESSIONS_RESTORE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Execute skill: {name}"
        "Execute skill: session-restore",
        "Execute skill: commit",
        "Execute skill: review-pr",
        "Execute skill: boot",
        "Execute skill: telos",
        "Execute skill: monitor-status",
    ],
    scope_constraints=[
...
MEMORY_STORE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Store agent memory: {key}"
        "Store agent memory: project_conventions",
        "Store agent memory: coding_standards",
        "Store agent memory: api_endpoint_format",
        "Store agent memory: deployment_config",
        "Store agent memory: user_preferences",
        "Store agent memory: architecture_decisions",
        "Store agent memory: test_patterns",
...
MEMORY_RETRIEVE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Retrieve agent memory: {key}"
        "Retrieve agent memory: project_conventions",
        "Retrieve agent memory: deployment_config",
        "Retrieve agent memory: api_endpoint_format",
        "Retrieve agent memory: coding_standards",
        "Retrieve agent memory: user_preferences",
        "Retrieve agent memory: architecture_decisions",
        "Retrieve agent memory: session_context",
    ],
    scope_constraints=[
...
MEMORY_SEARCH = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Search agent memory for: {query}"
        "Search agent memory for: testing conventions",
        "Search agent memory for: API documentation",
        "Search agent memory for: deployment procedures",
        "Search agent memory for: debugging notes",
...
UI_DISPLAY = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Enter planning mode for task decomposition" / "Exit planning mode"
        "Enter planning mode for task decomposition",
        "Exit planning mode",
        "Enter planning mode for task decomposition",
        "Exit planning mode",
        "Enter planning mode for task decomposition",
...
UI_PROMPT = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Ask user for input: {question}"
        "Ask user for input: Which implementation approach do you prefer?",
        "Ask user for input: Should I proceed with this change?",
        "Ask user for input: Which files should I include?",
        "Ask user for input: Do you want the verbose or concise version?",
        "Ask user for input: Should I run the full test suite?",
    ],
    scope_constraints=[
...
NODES_DELEGATE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Create sub-agent task: {desc}"
        "Create sub-agent task: research existing implementation patterns",
        "Create sub-agent task: explore codebase for related components",
        "Create sub-agent task: investigate test failures in CI",
        "Create sub-agent task: search for function definitions across modules",
        "Create sub-agent task: analyze dependencies for security issues",
        "Create sub-agent task: design implementation approach for feature",
        "Create sub-agent task: run test suite and report results",
        "Create sub-agent task: review code changes for best practices",
    ],
    scope_constraints=[
...
OPENCLAW_SKILL_INSTALL = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Install OpenClaw skill: {name}"
        "Install OpenClaw skill: code-formatter",
        "Install OpenClaw skill: db-migrate",
        "Install OpenClaw skill: test-runner",
        "Install OpenClaw skill: doc-generator",
        "Install OpenClaw skill: eslint-fixer",
    ],
    scope_constraints=[
...
OPENCLAW_SKILL_EXECUTE = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Execute OpenClaw skill: {name}"
        "Execute OpenClaw skill: code-formatter",
        "Execute OpenClaw skill: doc-generator",
        "Execute OpenClaw skill: db-seed",
        "Execute OpenClaw skill: security-scan",
        "Execute OpenClaw skill: lint-fix",
    ],
    scope_constraints=[
...
OPENCLAW_CONFIG_MODIFY = ToolDefinition(
    ...
    legitimate_exemplars=[
        # Bridge: "Modify OpenClaw configuration: {key}"
        "Modify OpenClaw configuration: workspace_boundaries",
        "Modify OpenClaw configuration: tool_access_list",
        "Modify OpenClaw configuration: sandbox_mode",
        "Modify OpenClaw configuration: permission_level",
        "Modify OpenClaw configuration: file_access_scope",
    ],
    scope_constraints=[
