...
class ThresholdConfig:
    ...
    # Chain weight redistribution: when True, redistribute chain weight to
    # purpose on ALL first-step events (no prior chain context). When False,
    # only redistribute when purpose_sub_qualified (sub-centroid match).
    # Live daemons should enable this to avoid 15% dead-weight loss on
    # first-step events. Benchmarks keep False to preserve calibration.
    chain_first_step_redistribute: bool = False
