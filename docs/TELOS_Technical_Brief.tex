...
\textbf{Statistical Validity:} Rule of Three 95\% CI upper bound: $<$0.12\% (3/2,550 = 0.118\%). Clopper-Pearson exact 95\% CI: [0\%, 0.14\%]. Fisher's exact compared to baseline: $p < 0.0001$.
...
TELOS achieves 0\% ASR across 2,550 attacks (Rule of Three 95\% CI upper bound: $<$0.12\%) through mathematical enforcement in embedding space. XSTest validation shows an 8.0\% false positive rate with domain-specific configuration.

\textbf{Reproducibility:} Code, data, and validation scripts can be found at \url{github.com/telos-ai-labs/telos}. All validation datasets published on Zenodo:
\begin{itemize}
