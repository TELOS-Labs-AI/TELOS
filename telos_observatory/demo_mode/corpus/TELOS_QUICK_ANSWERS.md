...
A mathematical framework for measuring whether the system is pulling conversations back toward the purpose over time. Think of it like tracking whether a ball is rolling downhill toward a valley -- if the energy function is decreasing, the system is converging toward its intended purpose.
