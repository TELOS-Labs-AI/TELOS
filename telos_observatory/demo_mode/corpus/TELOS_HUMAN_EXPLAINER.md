...
This is the mathematical framework for measuring whether the system is pulling conversations back toward the purpose over time, like tracking whether a ball is rolling downhill toward a valley.
...
TELOS works with any AI model - it operates at the governance control plane, not inside the model itself.
