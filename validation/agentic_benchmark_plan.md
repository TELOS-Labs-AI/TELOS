...
**Existing validation:** 0% observed ASR across 2,550 conversational attacks (HarmBench, AILuminate, MedSafetyBench, XSTest, SB 243). Now extending to agentic benchmarks.
