...
CORPUS_DIR = os.path.join(_SCRIPT_DIR, "corpus", "healthcare")
MEDSAFETY_RESULTS = os.path.join(_SCRIPT_DIR, "zenodo_medsafetybench", "medsafetybench_results_full.json")
PA_CONFIG = os.path.join(_SCRIPT_DIR, "zenodo_medsafetybench", "healthcare_hipaa_pa_config.json")
OUTPUT_DIR = os.path.join(_SCRIPT_DIR, "zenodo_medsafetybench")
