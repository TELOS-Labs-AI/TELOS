...
> **Note:** These systems use different benchmarks, threat models, and evaluation protocols. The other systems were evaluated with adaptive attacks specifically designed to bypass each system's defenses, while TELOS was evaluated with the same benchmark prompts under a black-box query-access threat model. This comparison is illustrative of the broader landscape, not a controlled methodological comparison.
...
| TELOS (SB 243) | 0.0% observed | 0.0% observed | This validation |
...
4. **Defense includes human escalation:** TELOS achieved 0% observed ASR through a combination of automated blocking (61.6%) and human expert escalation (38.4%)
...
3. Can the expert escalation tier be reduced while maintaining 0% observed ASR?
